...
export default function ItemRow({ name, description, id, price, image, entering }) {
    ...
    return (
        <>
            <Animated.View entering={entering} className="flex-row items-center bg-white p-3 rounded-3xl shadow-2xl mb-3 mx-2">
